...
export default [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: "/case-management/test-report",
        name: "测试报告",
        // access: ["testReport-preview", "testReport-edit"],
        component: "./case-management/test-report",
      },
      {
        path: "/case-management/test-report-detail/:id",
        name: "报告详情",
        component: "./case-management/test-report-detail",
        hideInMenu: true,
        headerRender: true,
        parentKeys: ["/case-management/test-report"],
      },
      {
        path: "/case-management/test-report-info",
        name: "报告控件",
        component: "./case-management/test-report-info",
        hideInMenu: true,
        headerRender: true,
        parentKeys: ["/case-management/test-report"],
      },
